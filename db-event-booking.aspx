<%@ Page Title="" Language="C#" MasterPageFile="~/Travelz.master" AutoEventWireup="true" CodeFile="db-event-booking.aspx.cs" Inherits="db_event_booking" %>
						...
						<table class="responsive-table">
							...
							<tbody>
								<tr>
									...
									<td><a href="db-event-details.aspx" class="db-done">view more</a>
									</td>
								</tr>
								<tr>
									<td>2</td>
