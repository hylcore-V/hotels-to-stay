<%@ Page Title="" Language="C#" MasterPageFile="~/Travelz.master" AutoEventWireup="true" CodeFile="booking-flight.aspx.cs" Inherits="booking_flight" %>
                            ...
                            <div id="bookingForm" class="contact__form v2-search-form" method="post" action="">
                                ...
                                <div class="row">
                                    <div class="input-field col s12">
                                        ...
                                        <asp:TextBox ID="selectsearch" CssClass="autosuggest" class="autosuggest" name="selectsearch" runat="server" required placeholder="Flying From"></asp:TextBox>
                                    </div>
                                    <div class="input-field col s12">
                                        <div class="input-field col s12">
                                            ...
                                            <asp:TextBox ID="txtflyto" CssClass="autosuggest" class="autosuggest" name="selectsearch" runat="server" required placeholder="Flying To"></asp:TextBox>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="input-field col s6">
                                        ...
                                        <asp:TextBox ID="txtArrivalDate" placeholder="Arrival Date" runat="server" CssClass="disable_past_dates" required />
                                        <cc1:CalendarExtender ID="CalendarExtender1" runat="server" TargetControlID="txtArrivalDate"
                                            PopupButtonID="txtArrivalDate" />
                                    </div>
                                    <div class="input-field col s6">
                                        <link href="css/CSS.css" rel="stylesheet" type="text/css" />
                                        <script src="js/Extension.min.js" type="text/javascript"></script>
                                        <asp:TextBox ID="txtDepartureDate" placeholder="Arrival Date" runat="server" CssClass="disable_past_dates" required />
                                        <cc1:CalendarExtender ID="CalendarExtender2" runat="server" TargetControlID="txtDepartureDate" PopupButtonID="txtDepartureDate" />
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="input-field col s6">
