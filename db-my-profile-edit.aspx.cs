...
public partial class db_my_profile_edit : System.Web.UI.Page
{
    ...
    {
        con.Open();
        SqlCommand cmd = new SqlCommand("Update SignUp Set Fname='" + txtfname.Text + "',Lname='" + txtlname.Text + "', Mobile='" + txtmobile.Text + "', Email='" + txtemail.Text + "', Password='" + txtpassword.Text + "', status='1'", con);
        cmd.ExecuteNonQuery();
