...
public partial class contact : System.Web.UI.Page
{
    ...
    {
        send_mail(cntname.Text, cntphone.Text, cntemail.Text, cntcity.Text);
        clear();
    ...
    public void send_mail(string name = "cntname.Text", string phone = "cntphone.Text", string email = "cntemail.Text", string city = "cntcity.Text")
    {
        con.Open();
        ...
        message.Subject = "Places To Go Inquiry : ";
