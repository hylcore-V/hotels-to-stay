...
[System.Web.Script.Services.ScriptService]
public class searchhotel : System.Web.Services.WebService
{
    ...
    public string[] FromSearch(string prefixText, int count)
    {
        ...
        using (SqlDataAdapter sda = new SqlDataAdapter(new SqlCommand("Select top 10 'keywords'= city from hotel_details where city like '%" + prefixText + "%' order by keywords", con)))
        {
