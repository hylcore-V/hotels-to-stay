...
[System.Web.Script.Services.ScriptService]
public class searchhotelevent : System.Web.Services.WebService
{

    public searchhotelevent()
    {
    ...
    public string[] FromSearch(string prefixText, int count)
    {
        ...
        using (SqlDataAdapter sda = new SqlDataAdapter(new SqlCommand("Select top 10 'keywords'= hotel from hotel_details where hotel like '%" + prefixText + "%' order by keywords", con)))
        {
