<%@ Page Title="" Language="C#" MasterPageFile="~/Travelz.master" AutoEventWireup="true" CodeFile="tour-details.aspx.cs" Inherits="tour_details" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <asp:ListView ID="lv_main" runat="server">
        <ItemTemplate>
            <section>
                <div class="rows inner_banner inner_banner_4" style="background: url(images/banner/<%# Eval("place_bannerimage") %>) no-repeat center center;">
                    <div class="container">
                        <%--<asp:Label ID="Label1" runat="server" Text='<%=Request.QueryString("place")%>'></asp:Label>--%>
                        <h2><span><%# Eval("place") %> (<%# Eval("state") %>) </span></h2>
                        <ul>
                            <li><a href="Default.aspx">Home</a>
                            </li>
                            <li><i class="fa fa-angle-right" aria-hidden="true"></i></li>
                            <li><a href="tour-details.aspx" class="bread-acti"><%# Eval("place") %> (<%# Eval("state") %>)</a>
                            </li>
                        </ul>
                    ...
                    <div class="container">
                        <div class="banner_book_1">
                            ...
                            <div class="tab-content">
                                <div class="tab-pane my-1 color-white fs-bold" id="nearby_hotel_tab" role="tabpanel" aria-labelledby="hotel_tab"><%# Eval("nearby_hotels") %></div>
                                ...
                                <div class="tab-pane my-1 color-white fs-bold" id="nearby_mals_tab" role="tabpanel" aria-labelledby="mall_tab"><%# Eval("nearby_malls") %></div>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-9">
                    <asp:ListView ID="lv_sub" runat="server">
                        <ItemTemplate>
                            <!--====== place TITLE ==========-->
                            <div class="tour_head">
                                <h2>The Best of <%# Eval("place") %>,<%# Eval("country") %> <span class="tour_star"><i class="fa fa-star" aria-hidden="true"></i><i class="fa fa-star" aria-hidden="true"></i><i class="fa fa-star" aria-hidden="true"></i><i class="fa fa-star" aria-hidden="true"></i><i class="fa fa-star-half-o" aria-hidden="true"></i></span><span class="tour_rat">4.5</span></h2>
                            </div>
                            <!--====== place Description ==========-->
                            ...
                            <div class="tour_head1 hotel-book-room">
                                <h3>Photo Gallery</h3>
                                <div id="Div1" class="carousel slide" data-bs-ride="carousel">
                                    ...
                                    <div class="carousel-inner" role="listbox">
                                        <asp:ListView ID="lv_slider" runat="server">
                                            <ItemTemplate>
                                                <div class="carousel-item <%# Eval("Id").ToString() == "1" ? "active" : "" %>">
                                                    <img src="images/TourDetails_GallerySlider/<%#Eval("placeimage") %>" class="w-100 d-block" alt="First slide">
                                                </div>
                                            </ItemTemplate>
                                        </asp:ListView>
                                    </div>
                    ...
                    <div class="tour_head1">
                        ...
                        <table>
                            ...
                            <asp:ListView ID="lv_aboutTour" runat="server">
                                <ItemTemplate>
                                    <tr>
                                        <td><%#Eval("Placescovered") %></td>
                                        <td class="event-res"><%#Eval("Inclusions") %></td>
                                        <td class="event-res"><%#Eval("Exclusions") %></td>
                    ...
                    <div class="tour_head1 l-info-pack-days days">
                        ...
                        <ul>
                            <asp:ListView ID="lst_tourschedule" runat="server">
                                <ItemTemplate>
                                    <li class="l-info-pack-plac"><i class="fa fa-clock-o" aria-hidden="true"></i>
                                        <h4><span>Day : <%#Eval("day") %></span> <%#Eval("daytitle") %></h4>
                                        <p><%#Eval("daydetails") %></p>
                                    </li>
                                </ItemTemplate>
                            </asp:ListView>
                            ...
                            <div class="dir-rat-inn">
                                <div class="dir-rat-form">
                                    ...
                                    <div class="form-group col-md-12 pad-left-o">
                                        <asp:TextBox ID="txmsg" runat="server" type="textarea" TextMode="MultiLine" placeholder="Write your message" required></asp:TextBox>
                                    </div>

                                    <div class="form-group col-md-12 pad-left-o">
                                        <asp:Button ID="BtnRatingsForm" OnClick="BtnRatingsForm_Click1" runat="server" Text="SUBMIT" type="submit" value="SUBMIT" class="link-btn" />
                                    </div>
                    ...
                    <ItemTemplate>
                        <div class="col-md-3 tour_r">
                            ...
                            <div class="tour_right tour_incl tour-ri-com">
                                ...
                                <ul>
                                    <li>Location : <%#Eval("place_name") %>,<%#Eval("state") %></li>
