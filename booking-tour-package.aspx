<%@ Page Title="" Language="C#" MasterPageFile="~/Travelz.master" AutoEventWireup="true" CodeFile="booking-tour-package.aspx.cs" Inherits="booking_tour_package" %>
                            ...
                            <div id="bookingForm" class="contact__form v2-search-form" method="post" action="">
                                ...
                                <div class="row">
                                    ...
                                    <div class="input-field col s6">
                                        <link href="css/CSS.css" rel="stylesheet" type="text/css" />
                                        <script src="js/Extension.min.js" type="text/javascript"></script>
                                        <asp:TextBox ID="txtDepartureDate" placeholder="Departure Date" runat="server" CssClass="disable_past_dates" required />
