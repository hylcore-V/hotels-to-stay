<%@ Page Title="" Language="C#" MasterPageFile="~/Travelz.master" AutoEventWireup="true" CodeFile="about.aspx.cs" Inherits="about" %>
			...
			<div class="row tourb2-ab-p1">
				<div class="col-md-6 col-sm-6">
						<div class="tourb2-ab-p1-left">
							<h3>Hi! Welcome to Places To Go</h3> <span>Places To Go is an Indian website for tourism , travelling , searching places , adventures , hotels , restaurants and many.</span>
							...
							<p>Fusce velit sem, vestibulum ac enim ut, tincidunt pretium augue. Vestibulum purus sapien, porttitor a porta faucibus, hendrerit eget enim.</p> <a href="tel:8999292525" class="link-btn">Call to us: +91 89992 92525</a> </div>
					</div>
				<div class="col-md-6 col-sm-6">
