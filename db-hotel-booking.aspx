<%@ Page Title="" Language="C#" MasterPageFile="~/Travelz.master" AutoEventWireup="true" CodeFile="db-hotel-booking.aspx.cs" Inherits="db_hotel_booking" %>
						...
						<table class="responsive-table">
							...
							<tbody>
								<tr>
									...
									<td><a href="db-hotel-details.aspx" class="db-done">view more</a>
									</td>
								</tr>
								<tr>
									<td>2</td>
