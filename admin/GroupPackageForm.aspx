<%@ Page Title="" Language="C#" MasterPageFile="~/admin/AdminMasterPage.master" AutoEventWireup="true" CodeFile="GroupPackageForm.aspx.cs" Inherits="admin_GroupPackageForm" %>
                        ...
                        <div class="row">
                            <div class="col-lg-12 col-md-12 col-sm-12 col-12">
                                <div class="form-group">
                                    <label for="ddl_selectplace">Select place For group package</label>
                                    <asp:DropDownList AutoPostBack="true" OnSelectedIndexChanged="ddl_selectplace_SelectedIndexChanged" ID="ddl_selectplace" runat="server" class="form-control form-control-lg" DataTextField="place" DataValueField="Id" AppendDataBoundItems="true">
                                        <asp:ListItem Value="-1" disabled Text="Select place For group package"></asp:ListItem>
                                    </asp:DropDownList>
                                </div>
            ...
            <div class="table-responsive">
                <table class="table" style="background-color: #fff;">
                    <thead>
                        <tr>
                            <th scope="col">Id</th>
                            <th scope="col">group Package Id</th>
