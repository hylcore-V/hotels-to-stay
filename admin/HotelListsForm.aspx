<%@ Page Title="" Language="C#" MasterPageFile="~/admin/AdminMasterPage.master" AutoEventWireup="true" CodeFile="HotelListsForm.aspx.cs" Inherits="admin_HotelListsForm" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <div class="row">
        ...
        <h4 class="card-title">( hotels-list.aspx )</h4>
                ...
                <div class="card-body">
                    <div class="forms-sample">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-6 col-12">
                                <div class="form-group">
                                    <label for="exampleInputUsername1">Enter Hotel List Desciption</label>
                                    <div>
