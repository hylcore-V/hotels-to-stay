<%@ Page Title="" Language="C#" MasterPageFile="~/admin/AdminMasterPage.master" AutoEventWireup="true" CodeFile="HotelDetailsSliderForm.aspx.cs" Inherits="admin_HotelDetailsSliderForm" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <div class="row">
                            <h1>Hotel Details Slider Form</h1>
                            <h4 class="card-title">Hotel Photo Gallery Slider ( hotel-details.aspx )</h4>
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        <div class="forms-sample">
                                            ...
                                            <div class="form-group">
                                                <label for="placeimage">Upload Hotel Image 1</label>
                                                <asp:FileUpload multiple="multiple" ID="placeimage" runat="server" class="form-control file-upload-info" placeholder="Upload Image" />
                                            </div>
                                            ...
                                            <asp:ListView ID="ListView1" runat="server" OnItemCommand="ListView1_ItemCommand" OnItemEditing="ListView1_ItemEditing" OnItemDeleting="ListView1_ItemDeleting">
                                                <ItemTemplate>
                                                    ...
                                                    <tr class="">
                                                        ...
                                                        <td>
                                                            <img src="../images/Hotel_Images/<%# Eval("placeimage") %>" /></td>
