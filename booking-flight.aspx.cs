...
public partial class booking_flight : System.Web.UI.Page
{
    ...
    {
        con.Open();
        SqlCommand cmd = new SqlCommand("INSERT INTO FlightBooking (name, phone, email, flyfrom, flyto, arrival_date, departure_date, adult_no, children_no, min_price, max_price, status, date) VALUES ('" + txtname.Text + "','" + txtphone.Text + "','" + txtemail.Text + "','" + selectsearch.Text + "','" + txtflyto.Text + "','" + txtArrivalDate.Text + "','" + txtDepartureDate.Text + "','" + ddl_adults.SelectedItem.Value + "','" + ddl_childrens.SelectedItem.Value + "','" + ddl_minprice.SelectedItem.Value + "','" + ddl_maxprice.SelectedItem.Value + "','1',getdate())", con);
        cmd.ExecuteNonQuery();
        cmd.Dispose();
        con.Close();
        send_mail(txtname.Text, txtphone.Text, txtemail.Text, selectsearch.Text, txtflyto.Text, txtArrivalDate.Text, txtDepartureDate.Text, ddl_adults.SelectedItem.Value, ddl_childrens.SelectedItem.Value, ddl_minprice.SelectedItem.Value, ddl_maxprice.SelectedItem.Value);
        clear();
        //Display success message.
        string message = "Thank you for arranging a wonderful Flight Booking with us! Our team will contact you shortly!";
    ...
    public void send_mail(string name = "txtname.Text", string phone = "txtphone.Text", string email = "txtemail.Text", string flyfrom = "selectsearch.Text", string flyto = "txtflyto.Text",
        ...
        string adults = "ddl_adults.SelectedItem.Value", string childrens = "ddl_childrens.SelectedItem.Value", string MinPrice = "ddl_minprice.SelectedItem.Value", string MaxPrice = "ddl_maxprice.SelectedItem.Value")
    {
        ...
        sb.AppendLine("Fly From City :- " + selectsearch.Text + "<br>");
        sb.AppendLine("Fly To City :- " + txtflyto.Text + "<br>");
        ...
        message.Subject = "Travelz Flight Booking details : ";
