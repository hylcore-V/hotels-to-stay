...
public partial class booking_car_rentals : System.Web.UI.Page
{
    ...
    {
        con.Open();
        SqlCommand cmd = new SqlCommand("INSERT INTO CarRentals (name, phone, email, pickup_loc, drop_loc, pick_date,pick_time, drop_date, drop_time ,selectcar ,totalpassangers, adult_no, children_no, min_price, max_price, status, date) VALUES ('" + txtname.Text + "','" + txtphone.Text + "','" + txtemail.Text + "','" + selectsearch.Text + "','" + txtdroploc.Text + "','" + txtArrivalDate.Text + "','" + ddl_picktime.SelectedItem.Value + "','" + txtdropdate.Text + "','" + ddl_droptime.SelectedItem.Value + "','" + ddl_selectcar.SelectedItem.Value + "','" + ddl_totalpassangers.SelectedItem.Value + "','" + ddl_adults.SelectedItem.Value + "','" + ddl_childrens.SelectedItem.Value + "','" + ddl_minprice.SelectedItem.Value + "','" + ddl_maxprice.SelectedItem.Value + "','1',getdate())", con);
        cmd.ExecuteNonQuery();
        cmd.Dispose();
        con.Close();
        send_mail(txtname.Text, txtphone.Text, txtemail.Text, selectsearch.Text, txtdroploc.Text, txtArrivalDate.Text, ddl_picktime.SelectedItem.Value, txtdropdate.Text,
            ddl_droptime.SelectedItem.Value, ddl_selectcar.SelectedItem.Value, ddl_totalpassangers.SelectedItem.Value, ddl_adults.SelectedItem.Value, ddl_childrens.SelectedItem.Value, ddl_minprice.SelectedItem.Value, ddl_maxprice.SelectedItem.Value);
        clear();
        //Display success message.
        string message = "Thank you for booking a car rental with us! Our team will contact you shortly!";
    ...
    public void clear()
    {
        ...
        txtArrivalDate.Text = "";
        txtdropdate.Text = "";
        this.ddl_picktime.ClearSelection();
        this.ddl_droptime.ClearSelection();
        this.ddl_selectcar.ClearSelection();
        this.ddl_totalpassangers.ClearSelection();
        this.ddl_adults.ClearSelection();
        this.ddl_childrens.ClearSelection();
        this.ddl_adults.ClearSelection();
        this.ddl_maxprice.ClearSelection();
    }
    public void send_mail(string name = "txtname.Text", string phone = "txtphone.Text", string email = "txtemail.Text", string pickup_loc = "selectsearch.Text", string drop_loc = "txtdroploc.Text",
        string pick_date = "txtArrivalDate.Text", string pick_time = "ddl_picktime.SelectedItem.Value", string drop_date = "txtdropdate.Text",
        string drop_time = "ddl_droptime.SelectedItem.Value",
        string selectcar = "ddl_selectcar.SelectedItem.Value", string totalpassengers = "ddl_totalpassangers.SelectedItem.Value", string adults = "ddl_adults.SelectedItem.Value", string childrens = "ddl_childrens.SelectedItem.Value", string MinPrice = "ddl_minprice.SelectedItem.Value", string MaxPrice = "ddl_maxprice.SelectedItem.Value")
    {
        con.Open();
        ...
        sb.AppendLine("Pick up location :- " + selectsearch.Text + "<br>");
        sb.AppendLine("Dropping off location :- " + txtdroploc.Text + "<br>");
        sb.AppendLine("Pick up date :- " + txtArrivalDate.Text + "<br>");
        sb.AppendLine("Pick up time :- " + ddl_picktime.SelectedItem.Value + "<br>");
        sb.AppendLine("Drop off date :- " + txtdropdate.Text + "<br>");
        sb.AppendLine("Select car type :- " + ddl_selectcar.SelectedItem.Value + "<br>");
        sb.AppendLine("Total passengers :- " + ddl_totalpassangers.SelectedItem.Value + "<br>");
        ...
        message.Subject = "Travelz Car Rentals booking details : ";
