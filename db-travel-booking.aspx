<%@ Page Title="" Language="C#" MasterPageFile="~/Travelz.master" AutoEventWireup="true" CodeFile="db-travel-booking.aspx.cs" Inherits="db_travel_booking" %>
						...
						<table class="responsive-table">
							...
							<tbody>
								<tr>
									...
									<td><a href="db-travel-details.aspx" class="db-done">view more</a>
									</td>
								</tr>
								<tr>
									<td>2</td>
