<%@ Page Title="" Language="C#" MasterPageFile="~/Travelz.master" AutoEventWireup="true" CodeFile="booking-hotel.aspx.cs" Inherits="booking_hotel" %>
                            ...
                            <div id="bookingForm" class="contact__form v2-search-form" method="post" action="">
                                ...
                                <div class="row">
                                    <div class="input-field col s12">
                                        ...
                                        <asp:TextBox ID="selectsearch" CssClass="autosuggest" class="autosuggest" name="selectsearch" runat="server" required placeholder="City, Destination and Hotel Name"></asp:TextBox>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="input-field col s6">
                                        ...
                                        <asp:TextBox ID="txtcheckin" runat="server" CssClass="disable_past_dates" Style="width: 80%;" required />
                                        <asp:ImageButton runat="server" ID="ImageButton1" CssClass="imgPopup" ImageUrl="images/Calendar.png" />
                                        <cc1:CalendarExtender ID="CalendarExtender1" runat="server" TargetControlID="txtcheckin" PopupButtonID="ImageButton1" />
                                        <label for="txtcheckin">Check In</label>
                                    </div>
                                    <div class="input-field col s6">
                                        <link href="css/CSS.css" rel="stylesheet" type="text/css" />
                                        <script src="js/Extension.min.js" type="text/javascript"></script>
                                        <asp:TextBox ID="txtcheckout" runat="server" CssClass="disable_past_dates" Style="width: 80%;" required />
                                        <asp:ImageButton runat="server" ID="ImageButton2" CssClass="imgPopup" ImageUrl="images/Calendar.png" />
                                        <cc1:CalendarExtender ID="CalendarExtender2" runat="server" TargetControlID="txtcheckout" PopupButtonID="ImageButton2" />
                                        <label for="txtcheckout">Check Out</label>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="input-field col s6">
                                        <asp:DropDownList ID="ddl_totalrooms" runat="server" required>
                                            <asp:ListItem Value="" disabled Selected>No of Rooms</asp:ListItem>
                                    ...
                                    <div class="input-field col s6">
                                        <asp:DropDownList ID="ddl_roomtype" runat="server" required>
                                            <asp:ListItem Value="" disabled Selected>Room Type</asp:ListItem>
                                            <asp:ListItem Value="Ultra Premium">Ultra Premium</asp:ListItem>
                                            <asp:ListItem Value="Ultra Deluxe">Ultra Deluxe</asp:ListItem>
